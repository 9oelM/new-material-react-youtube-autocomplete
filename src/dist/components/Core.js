...
function (_React$Component) {
  ...
  function Core(props) {
    ...
    _this.handleSuggestError = props.onSuggestError; //this.handleSuggestError = this.handleSuggestError.bind(this)

    _this.handleSearchError = props.onSearchError; // this.handleSearchError = this.handleSearchError.bind(this)

    _this.handleSearchResults = props.onSearchResults; //this.handleSearchResults = this.handleSearchResults.bind(this)
  ...
  _createClass(Core, [{
    ...
    value: function fetchSearchResults(searchWord) {
      ...
      (0, _youtubeSearch.default)(searchWord, option, function (err, results) {
        if (err) {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
        ...
        primary: _blue.default
          ...
          placeholder = _this$props$placehold === void 0 ? 'Search youtube' : _this$props$placehold;
